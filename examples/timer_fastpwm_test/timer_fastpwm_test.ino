...
void setup()
{
  ...
  OUTLED &= 0x7F;								// Initially turn LED off.
	...
	//TIMER0 SETTINGS.
	t0.initialize(t_settings::mode::PWM_F,
								t_settings::channel::A,
								t_settings::inverted::NORMAL);		// t_settings::channel::A sets pwm channels A on T0 (Pin PB7).
	...
	//TIMER1 SETTINGS.
	t1.initialize(t_settings::mode::PWM_F,
								t_settings::channel::BC_TOP,
								t_settings::inverted::NORMAL);	// t_settings::channel::BC_TOP sets A as TOP and pwm channels B and C.
